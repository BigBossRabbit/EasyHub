  ...
  return (
    <div className="min-h-screen text-foreground">
      ...
      <header className="py-12 text-center border-b border-white/10 mb-12">
        ...
        {/* Africa Bitcoin Day 2026 Pool Tournament */}
          ...
          <div className="container mx-auto px-6">
            <div className="space-y-6">
              ...
              <div className="grid md:grid-cols-2 gap-6">
                <div>
                  <h3 className="text-lg font-bold text-yellow-400 mb-2">📊 Tournament Stats</h3>
                  <p className="space-y-2 text-sm">
                    • <span className="font-medium">Format:</span> Single Elimination Pool Tournament
                    <br/>• <span className="font-medium">Participants:</span> 22 players
                    <br/>• <span className="font-medium">Date:</span> 23 May 2026
                    <br/>• <span className="font-medium">Location:</span> Joker's Pizzeria, Windhoek
                    <br/>• <span className="font-medium">Organized by:</span> EasySats & OKIN.Ent
                    <br/>• <span className="font-medium">Supported by:</span> African Bitcoin Community Hub
                    <br/>• <span className="font-medium">Entry Fee:</span> 50 NAD (donated to prize pool)
                    <br/>• <span className="font-medium">Phone Validation:</span> +2648XXXXXX format
                  </p>
                </div>
                <div>
                  <h3 className="text-lg font-bold text-yellow-400 mb-2">🎉 Event Highlights</h3>
                  <p className="space-y-2 text-sm">
                    • <span className="font-medium">Successful completion</span> of all matches
                    <br/>• <span className="font-medium">Community engagement</span> with Bitcoin education
                    <br/>• <span className="font-medium">Fun and competitive atmosphere</span> at Joker's Pizzeria
                    <br/>• <span className="font-medium">All entry fees converted to Bitcoin prizes</span>
                    <br/>• <span className="font-medium">Positive feedback</span> from participants and sponsors
                  </p>
                </div>
              </div>
            </div>
